...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/flag/nanotrasen, STANDARD_TILE_OFFSET)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/flag/ssc, STANDARD_TILE_OFFSET)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/flag/terragov, STANDARD_TILE_OFFSET)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/flag/tizira, STANDARD_TILE_OFFSET)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/flag/mothic, STANDARD_TILE_OFFSET)
...
MAPPING_DIRECTIONAL_HELPERS(/obj/structure/sign/flag/mars, STANDARD_TILE_OFFSET)
