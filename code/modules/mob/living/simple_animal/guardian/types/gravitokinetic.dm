...
/mob/living/basic/guardian/gravitokinetic/AttackingTarget()
	. = ..()
...
/mob/living/basic/guardian/gravitokinetic/AltClickOn(atom/A)
...
/mob/living/basic/guardian/gravitokinetic/proc/add_gravity(atom/A, new_gravity = 3)
...
/mob/living/basic/guardian/gravitokinetic/proc/__distance_check(atom/movable/AM, OldLoc, Dir, Forced)
	SIGNAL_HANDLER
